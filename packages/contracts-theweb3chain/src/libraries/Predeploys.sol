...
/// @title Predeploys
/// @notice Contains constant addresses for protocol contracts that are pre-deployed to the core system.
...
library Predeploys {
    ...
    ///         or access tx.origin (or msg.sender) in a L1 to core transaction instead.
