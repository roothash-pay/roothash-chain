...
Every interfaces name ending with "Client" represents a client-binding:
...
E.g. a `uint64` argument instead of a `hexutil.Uint64`, or return an interfaces rather than a concrete type.
...
Every interfaces name ending with "Server" represents a server-binding:
...
always prefer to consume the smaller fitting interfaces, to increase compatibility.
