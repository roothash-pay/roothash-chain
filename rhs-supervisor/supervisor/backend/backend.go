...
import (
	...
	"github.com/roothash-pay/roothash-chain/rhs-service/locks"
	"github.com/roothash-pay/roothash-chain/rhs-service/sources"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/config"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/cross"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/db"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/db/sync"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/depset"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/l1access"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/processors"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/rewinder"
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/backend/status"
	...
	"github.com/roothash-pay/roothash-chain/rhs-supervisor/supervisor/frontend"
