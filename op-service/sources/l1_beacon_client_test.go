...
import (
	...
	client_mocks "github.com/cpchain-network/cp-chain/op-service/client/mocks"
	"github.com/cpchain-network/cp-chain/op-service/eth"
	"github.com/cpchain-network/cp-chain/op-service/sources/mocks"
)

//go:generate mockery --srcpkg=github.com/cpchain-network/cp-chain/op-service/apis --name BlobSideCarsClient --with-expecter=true

//go:generate mockery --srcpkg=github.com/cpchain-network/cp-chain/op-service/apis --name BeaconClient --with-expecter=true
