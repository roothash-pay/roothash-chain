...
import (
	...
	"github.com/cpchain-network/cp-chain/cp-program/chainconfig"
	"github.com/cpchain-network/cp-chain/cp-program/client/boot"
	"github.com/cpchain-network/cp-chain/cp-program/client/interop/types"
	"github.com/cpchain-network/cp-chain/cp-program/client/l1"
	"github.com/cpchain-network/cp-chain/cp-program/client/l2"
	"github.com/cpchain-network/cp-chain/cp-program/client/l2/test"
	"github.com/cpchain-network/cp-chain/cp-program/client/tasks"
	...
	supervisortypes "github.com/cpchain-network/cp-chain/cp-supervisor/supervisor/types"
