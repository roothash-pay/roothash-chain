...
import (
	...
	opnode "github.com/roothash-pay/roothash-chain/rhs-node"
	"github.com/roothash-pay/roothash-chain/rhs-node/chaincfg"
	"github.com/roothash-pay/roothash-chain/rhs-node/cmd/genesis"
	"github.com/roothash-pay/roothash-chain/rhs-node/cmd/interop"
	"github.com/roothash-pay/roothash-chain/rhs-node/cmd/networks"
	"github.com/roothash-pay/roothash-chain/rhs-node/cmd/p2p"
	"github.com/roothash-pay/roothash-chain/rhs-node/flags"
	"github.com/roothash-pay/roothash-chain/rhs-node/metrics"
	"github.com/roothash-pay/roothash-chain/rhs-node/node"
	"github.com/roothash-pay/roothash-chain/rhs-node/version"
