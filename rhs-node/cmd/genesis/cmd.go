...
var (
	...
	outfileL2Flag = &cli.PathFlag{
		Name:  "outfile.l2",
		Usage: "Path to core genesis output file",
	}
	...
	l2AllocsFlag = &cli.StringFlag{
		Name:  "l2-allocs",
		Usage: "Path to core genesis state dump",
	}
...
var Subcommands = cli.Commands{
	...
	{
		Name:  "l2",
		Usage: "Generates an core genesis file and rollup config suitable for a deployed network",
		Description: "Generating the core genesis depends on knowledge of L1 contract addresses for the bridge to be secure. " +
			"A deploy config and either a deployment directory or an L1 deployments file are used to create the core genesis. " +
