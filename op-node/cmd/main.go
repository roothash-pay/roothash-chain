...
import (
	...
	opnode "github.com/cpchain-network/cp-chain/op-node"
	"github.com/cpchain-network/cp-chain/op-node/chaincfg"
	"github.com/cpchain-network/cp-chain/op-node/cmd/genesis"
	"github.com/cpchain-network/cp-chain/op-node/cmd/interop"
	"github.com/cpchain-network/cp-chain/op-node/cmd/networks"
	"github.com/cpchain-network/cp-chain/op-node/cmd/p2p"
	"github.com/cpchain-network/cp-chain/op-node/flags"
	"github.com/cpchain-network/cp-chain/op-node/metrics"
	"github.com/cpchain-network/cp-chain/op-node/node"
